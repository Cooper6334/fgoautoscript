...
function getFriendLine(screenshot){
    ...
    for(var y = 255;y<795;y++){
      ...
      for(var i=0;i<pixelColor.length;i+=2){
        ...
        var screenshotColor1 = getImageColor(screenshot,defaultMarginX + positionX[x],y);
        var screenshotColor2 = getImageColor(screenshot,defaultMarginX + positionX[x+1],y);
