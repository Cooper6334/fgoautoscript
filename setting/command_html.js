...
function getSpaceUltItem(id){
    return getCommandItem(id,"設定技能改變寶具顏色",
        '<li><label>寶具顏色&nbsp;&nbsp;</label>'+
        '<select id = "spaceUltColor'+id+'">'+
...
function getSelectFriend(id){
    return getCommandItem(id,'選擇好友',
        ...
        '<input type="checkbox" id = "selectFriend8'+id +'">特&nbsp'+
        '<input type="checkbox" id = "selectFriend9'+id +'">混<br>'+
